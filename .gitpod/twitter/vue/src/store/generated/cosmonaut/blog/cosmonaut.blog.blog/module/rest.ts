...
export type BlogMsgCreateDummyResponse = object;

export interface BlogMsgCreateFollowResponse {
  /** @format uint64 */
  id?: string;
}
...
export interface BlogPostWithComments {
  post?: BlogPost;
...
export interface BlogQueryAllFollowResponse {
  Follow?: BlogFollow[];
...
export interface BlogQueryGetFollowResponse {
  Follow?: BlogFollow;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryFollowAll
   * @summary Queries a list of Follow items.
   * @request GET:/cosmonaut/blog/blog/follow
   */
  queryFollowAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllFollowResponse, RpcStatus>({
      path: `/cosmonaut/blog/blog/follow`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryFollow
   * @summary Queries a Follow by id.
   * @request GET:/cosmonaut/blog/blog/follow/{id}
   */
  queryFollow = (id: string, params: RequestParams = {}) =>
   ...
   *
   * @tags Query
   * @name QueryFollowingPosts
   * @summary Queries a list of FollowingPosts items.
   * @request GET:/cosmonaut/blog/blog/following_posts/{id}
   */
  queryFollowingPosts = (id: string, query?: { creator?: string }, params: RequestParams = {}) =>
    this.request<BlogQueryFollowingPostsResponse, RpcStatus>({
      path: `/cosmonaut/blog/blog/following_posts/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
