...
export interface MsgCreateFollow {
  creator: string;
  following: string;
}

export interface MsgCreateFollowResponse {
  id: number;
}
...
const baseMsgCreateFollow: object = { creator: "", following: "" };

export const MsgCreateFollow = {
  encode(message: MsgCreateFollow, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.following !== "") {
      writer.uint32(18).string(message.following);
    }
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): MsgCreateFollow {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgCreateFollow } as MsgCreateFollow;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgCreateFollow {
    const message = { ...baseMsgCreateFollow } as MsgCreateFollow;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = String(object.creator);
    } else {
  ...
  toJSON(message: MsgCreateFollow): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
  ...
  fromPartial(object: DeepPartial<MsgCreateFollow>): MsgCreateFollow {
    const message = { ...baseMsgCreateFollow } as MsgCreateFollow;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    } else {
...
const baseMsgCreateFollowResponse: object = { id: 0 };

export const MsgCreateFollowResponse = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateFollowResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateFollowResponse,
    } as MsgCreateFollowResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgCreateFollowResponse {
    const message = {
      ...baseMsgCreateFollowResponse,
    } as MsgCreateFollowResponse;
    if (object.id !== undefined && object.id !== null) {
  ...
  toJSON(message: MsgCreateFollowResponse): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = message.id);
    return obj;
  },
  ...
  fromPartial(
    object: DeepPartial<MsgCreateFollowResponse>
  ): MsgCreateFollowResponse {
    const message = {
      ...baseMsgCreateFollowResponse,
    } as MsgCreateFollowResponse;
    if (object.id !== undefined && object.id !== null) {
...
export interface Msg {
  ...
  CreateFollow(request: MsgCreateFollow): Promise<MsgCreateFollowResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateFollow(request: MsgCreateFollow): Promise<MsgCreateFollowResponse> {
    const data = MsgCreateFollow.encode(request).finish();
    const promise = this.rpc.request(
      "cosmonaut.blog.blog.Msg",
      "CreateFollow",
      data
    ...
    return promise.then((data) =>
      MsgCreateFollowResponse.decode(new Reader(data))
    );
  }
}
